...
export default function Products(){
    return(
        ...
        <h2 className="text-6xl text-gray-600 dark:text-white">Letest Sale Outs</h2>
        <div className="flex flex-col">
          <div className="flex flex-col justify-center">
            <div className="relative">
              <Image className="hidden sm:block w-full" src="/assets/Present 2.png" alt="sofa" width='400' height='350'/>
              <Image className="sm:hidden w-full" src="/assets/Scene 1.png" alt="sofa" width='400' height='350'/>
              <Image className="sm:hidden w-full" src="/assets/Present 2.png" alt="sofa" width='400' height='350'/>
          ...
          <div className="mt-10 grid lg:grid-cols-2 gap-x-8 gap-y-8 items-center">
            <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center">
              <Image className="group-hover:opacity-60 transition duration-500" src="/assets/Shopping Bag 1.png" alt="" width='400' height='350'/>
            ...
            <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center">
              <Image className="group-hover:opacity-60 transition duration-500" src="/assets/Scene 1.png" alt="sofa-3" width='400' height='350' />
              <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                <div>
            ...
            <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center">
              <Image className="group-hover:opacity-60 transition duration-500" src="/assets/Diamond 1.png" alt="sofa-4" width='400' height='350' />
              <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                <div>
                  <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600 dark:text-white">Sectional Sofa</p>
                </div>
            ...
            <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center">
              <Image className="group-hover:opacity-60 transition duration-500" src="/assets/Scene 2.png" alt="sofa-6" width='400' height='350'/>
              <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                <div>
                  <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600 dark:text-white">Sectional Sofa</p>
                </div>
