        ...
        <div className="container px-4 mx-auto">
          <div className="relative max-w-5xl sm:px-6 pb-6 mb-10 mx-auto text-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl md:text-5xl font-semibold tracking-tighter underline decoration-wavy decoration-4 decoration-green-600 " data-config-id="auto-txt-2-1">Our sales team is<span className="text-green-600">good at their job</span> !.</h2>
            </div>
          </div>
          <div className="text-center mb-8">
            <Image className="mx-auto mb-6 rounded-full" src="/assets/avatar.jpg" alt="" height='60' width= '60' />
            <h3 className="mb-2 text-xl md:text-2xl font-semibold" data-config-id="auto-txt-3-1">Dorothy Kassam</h3>
            <span className="text-lg text-gray-400 font-medium" data-config-id="auto-txt-4-1">Marketing Executive &amp; Founder </span>
          </div>
